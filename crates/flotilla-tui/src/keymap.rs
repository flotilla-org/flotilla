...
impl Action {
    ...
    pub fn from_config_str(s: &str) -> Option<Action> {
        let action = match s {
            ...
            "open_table_filter" => Action::OpenTableFilter,
            "open_source_search" => Action::OpenSourceSearch,
    ...
    pub fn as_config_str(&self) -> &'static str {
        match self {
            ...
            Action::OpenTableFilter => "open_table_filter",
            Action::OpenSourceSearch => "open_source_search",
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Action::OpenTableFilter => "Filter table locally",
            Action::OpenSourceSearch => "Search issue sources",
