...
use crate::{
    ...
    DispatchObservation, Environment, Event, FieldOwnedResource, Host, InputMeta, ObjectMeta, OwnerReference, PlacementPolicy,
...
macro_rules! dispatch_resource_kind {
    ...
    ($resource:expr, $body:ident()) => {
        match $resource {
            ...
            RegisteredResource::CrewImageBaseline => $body::<CrewImageBaseline>(),
    ...
    ($resource:expr, $body:ident($($arg:expr),*)) => {
        match $resource {
            ...
            RegisteredResource::CrewImageBaseline => $body::<CrewImageBaseline>($($arg),*),
